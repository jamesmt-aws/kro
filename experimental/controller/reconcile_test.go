...
func TestForEach_CarryForwardStampsUpdatedFromLabel(t *testing.T) {
	...
	r := &GraphReconciler{}
	_, err = r.reconcileForEach(context.Background(), graph, spec.Nodes[1], eval, nil, prevState)
...
func TestForEach_DefinitionItemsAlwaysReEvaluated(t *testing.T) {
	...
	r := &GraphReconciler{}
	_, err = r.reconcileForEach(context.Background(), graph, spec.Nodes[1], eval, nil, nil)
	require.NoError(t, err)
...
func TestForEach_RegressionSharedContextPropagation(t *testing.T) {
	...
	out, err := r.reconcileForEach(context.Background(), graph, resultsNode, eval, nil, nil)
	require.NoError(t, err)
	...
	_, err = r.reconcileForEach(context.Background(), graph, resultsNode, eval2, nil, prevState2)
	require.NoError(t, err)
